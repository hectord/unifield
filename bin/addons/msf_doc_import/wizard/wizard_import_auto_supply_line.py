...
class wizard_import_auto_supply_line(osv.osv_memory):
    _name = 'wizard.import.auto.supply.line'
    _description = 'Import Automatic supply lines from Excel sheet'
    ...
    _columns = {
        ...
        'rule_id': fields.many2one('stock.warehouse.automatic.supply', string='Rule', required=True),
    ...
    def _import(self, dbname, uid, ids, context=None):
        ...
        rule_obj = self.pool.get('stock.warehouse.automatic.supply')
        rule_line_obj = self.pool.get('stock.warehouse.automatic.supply.line')
        line_with_error = []
        vals = {'rule_line_ids': []}
...
wizard_import_auto_supply_line()
