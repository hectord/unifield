...
class min_max_rules_report(osv.osv):
    ...
    _columns = {
        'rule_id': fields.many2one('stock.warehouse.orderpoint', string='Rules reference', readonly=True),
        ...
        'min_qty': fields.float(digits=(16,2), string='Min. Qty', readonly=True),
        'max_qty': fields.float(digits=(16,2), string='Max. Qty', readonly=True),
        'multiple_qty': fields.float(digits=(16,2), string='Multiple Qty', readonly=True),
    ...
    def init(self, cr):
        ...
        '''
        tools.drop_view_if_exists(cr, 'min_max_rules_report')
        cr.execute("""
